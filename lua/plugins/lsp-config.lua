return {
    ...
    },
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>cgd", vim.lsp.buf.definition, { desc = "[C]ode Goto [D]efinition" })
            ...
            vim.keymap.set("n", "<leader>cgD", vim.lsp.buf.declaration, { desc = "[C]ode Goto [D]eclaration" })
        end,
    },
}
